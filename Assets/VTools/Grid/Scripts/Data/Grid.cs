...
namespace VTools.Grid
{
    public class Grid
    {
        ...
        public Vector3 GetWorldPosition(Vector2Int coordinates)
        {
            ...
            return new Vector3(coordinates.x, coordinates.y, 0) * CellSize + OriginPosition;
        }
		...
		public List<Cell> GetCellsInCircle(Vector3 center, float radius)
		{
			...
			foreach (Cell cell in _cells)
			{
                ...
                Vector3 cellWorldPosition = GetWorldPosition(cell.Coordinates.x, cell.Coordinates.y) + new Vector3(CellSize / 2, CellSize / 2, 0);
        ...
        public void DrawGridDebug()
        {
            ...
            for (int x = 0; x < _gridArray.GetLength(0); x++)
            {
                for (int y = 0; y < _gridArray.GetLength(1); y++)
                {
                    ...
                    var worldPosition = GetWorldPosition(x, y) + new Vector3(CellSize / 2, CellSize / 2, 0);
                    ...
                    debugTextArray[x][y].transform.rotation = Quaternion.identity;
