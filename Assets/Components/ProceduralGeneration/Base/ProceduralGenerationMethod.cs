...
namespace Components.ProceduralGeneration
{
    public abstract class ProceduralGenerationMethod : ScriptableObject
    {
        ...
        protected const string GRASS_ON_ROCK_TILE_NAME = "RockGrass";
        ...
        protected const string RED_SAND_TILE_NAME = "RedSand";
        protected const string RED_ROCK_TILE_NAME = "RedRock";
        protected const string RED_ROCK_HARD_TILE_NAME = "RedRockHard";
        protected const string DIRT_TILE_NAME = "Dirt";
